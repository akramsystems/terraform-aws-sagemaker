...
resource "aws_sagemaker_device" "sagemaker_device" {
  ...
  device_fleet_name = var.sagemaker_device_fleet_name != "" ? var.sagemaker_device_fleet_name : (var.enable_sagemaker_device ? aws_sagemaker_device_fleet.sagemaker_device_fleet[count.index].device_fleet_name : null)
